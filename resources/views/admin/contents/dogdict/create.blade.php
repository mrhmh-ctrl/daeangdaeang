@include('admin.inc.admin_header')
        ...
        <div class="admin-contents">
            ...
            @endif
            <form method="POST" action="{{ route('admin.dogdict.store') }}" enctype="multipart/form-data">
                @csrf
                <table class="admin-form-table">
                    ...
                    <tr>
                        <th>내용 *</th>
                        <td>
                            <textarea name="content" id="content" rows="20" style="width:100%;">{{ old('content') }}</textarea>
                        </td>
                    </tr>
                </table>
